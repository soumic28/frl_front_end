      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10">
        ...
        <div className="flex flex-row">
          <div className="flex flex-col">
            <div className="flex flex-col">
              <p className="text-white sm:text-3xl font-semibold sm:leading-10">
                Investing in people for
                <br />
                Building and Transforming Systems
              </p>
              <p className="text-sky-950 sm:text-3xl font-normal sm:leading-10">
                That can make everyone a part of solutions <br />
                to the Climate Crisis
              </p>
            </div>
            <div className="flex gap-4 mt-8">
              <button className="w-32 h-11 mix-blend-overlay bg-white rounded-[30px] px-6 py-3  text-sky-950 font-medium hover:bg-sky-100 transition-colors flex items-center gap-2">
                <svg
                  className="pt-1"
                  width="21"
                  height="22"
                ...
                <p className="justify-start text-sky-800 text-xl font-medium">
                  Login
                </p>
              </button>
              <button className="px-6 py-3 bg-transparent text-white rounded-full font-medium hover:bg-white/10 transition-colors flex items-center gap-2">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  strokeWidth={1.5}
